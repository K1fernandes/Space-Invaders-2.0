...
JOG = py.image.load('COD/jogo/IMG/FUNDO.jpg').convert_alpha()
JOG = py.transform.scale(JOG, (x, y))

#CARREGAR IMAGEM OVNI
OVNI = py.image.load('COD/jogo/IMG/OVNI.png').convert_alpha()
OVNI = py.transform.scale(OVNI, (50,50))

#CARREGAR IMAGEM PLAYER
PLAYER = py.image.load('COD/jogo/IMG/nave.png').convert_alpha()
PLAYER = py.transform.scale(PLAYER, (50,50))

#CARREGAR IMAGEM TIRO
TIRO = py.image.load('COD/jogo/IMG/tiro.png').convert_alpha()
